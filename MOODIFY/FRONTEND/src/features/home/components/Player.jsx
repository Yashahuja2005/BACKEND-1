...
const Player = () => {
    const { song, queue, currentIndex, nextSong, previousSong } = useSong()

    const audioRef = useRef(null)
    const progressRef = useRef(null)
    const continueQueueRef = useRef(false)
    ...
    useEffect(() => {
        if (audioRef.current) {
            ...
            if (continueQueueRef.current) {
                ...
                audioRef.current.addEventListener('loadeddata', resume, { once: true })
            } else {
                setIsPlaying(false)
            }
        }
        ...
        <div className="player">
            ...
            <div className="player__info">
                ...
                <div className="player__meta">
                    ...
                    <span className="player__artist">{song.artist || 'Moodify radio'} · {currentIndex + 1}/{queue.length}</span>
                </div>
            </div>
            ...
            <div className="player__controls">
                ...
                {/* Backward 5s */}
                <button className="player__btn player__btn--skip" onClick={goPrevious} title="Previous song">
                ...
                {/* Forward 5s */}
                <button className="player__btn player__btn--skip" onClick={nextSong} title="Next song">
                    <span>›</span>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="20" height="20">
                        <path d="M23 4v6h-6"/>
